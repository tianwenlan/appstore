...
class DataService(object):
	...
	def retrieve_user_download_history(cls, filter_dict={}):
		#return a dict {user_id: download_history} containing user download_history Data
	...
	def retrieve_app_info(cls, filter_dict={}):
		#return a dict {app_id: {app_name, top_5_app}} containing user download_history Data
		#return all data in the collection if no filter is specified
		result = {}
	...
	def update_app_info(cls, filter_dict, update): 
		cls.app_info.update_one(filter_dict, update, True) #mongodb update_one